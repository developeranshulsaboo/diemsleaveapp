...
class DirectorSpace extends StatefulWidget {
  @override
  _DirectorSpaceState createState() => _DirectorSpaceState();
}

class _DirectorSpaceState extends State<DirectorSpace> {
  @override
  Widget build(BuildContext context) {
    ...
    Future<List> fetchRequest() async {
      ...
      Map<String, String> header = {
        "Authorization": "Bearer keyxSmsAvXynpKA6x"
      };
            ...
            : ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  for (index; index < records.length; index++) {
                    if (records[index]['fields']['Status2'] == "Accepted") {
                      return Card(
                        child: Column(
